...
### 2️⃣ Render Depth Video (`depth_render_video.py`)

Generates a spiral-view depth visualization of the stylized scene.

### 3️⃣ Render RGB Video (`render_video.py`)
...
For each stylization run, results are stored as:
